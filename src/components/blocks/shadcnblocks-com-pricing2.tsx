...
/**
 * Pricing2 — from 21st.dev
 * Source: https://21st.dev/r/shadcnblockscom/pricing2
 * Install: npx shadcn@latest add https://21st.dev/r/shadcnblockscom/pricing2
 */
              ...
              <Card key={plan.id} className="flex w-80 flex-col justify-between text-left">
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">
                    {isYearly ? "Platnost 3 měsíce" : "Platnost dle balíčku"}
                  </p>
                </CardHeader>
                <CardContent>
                  <Separator className="mb-6" />
                  {plan.id === "pro" && (
                    <p className="mb-3 font-semibold">Vše z Plus a navíc:</p>
                  )}
